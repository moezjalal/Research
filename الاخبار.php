...
<nav class="navbar navbar-expand-lg navbar-light bg-body-tertiary fixed-top" style="font-size:19px;">
    ...
    <div class="card-img-overlay">
        <p class="card-text text-white">في هذي الصفحه سوف تجد جميع الاخبار</p> 
    </div>
</div>
...
$sql = "SELECT id, title, summary, image, content FROM news ORDER BY reg_date DESC LIMIT 30000"; // تم إضافة 'id' في الاستعلام
