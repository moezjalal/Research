...
<body>
    ...
    <div class="sidebar">
        ...
        <li><a href="en"><i class="fas fa-plus"></i>EN</a></li>
        <ul>
            <!-- قسم الأخبار -->
            ...
            <!-- قسم القرارات -->
            <li class="active"><a href="index.php"><i class="fas fa-plus"></i> إضافة قرار</a></li>
    ...
    <div class="content" style="flex-grow: 1; padding: 0; margin-right: 250px; max-width: 90%;">
        <div class="card" style="border: 1px solid #ddd; border-radius: 8px; padding: 20px; background-color: #ffffff; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); margin: 0;">
            ...
            <!-- المحتوى الرئيسي -->
            <form action="add_decision.php" method="post" enctype="multipart/form-data" style="display: flex; flex-direction: column; gap: 15px;">
                <div class="form-group" style="display: flex; flex-direction: column;">
                    <label for="title" style="font-weight: bold; margin-bottom: 5px;">عنوان القرار</label>
                    <input type="text" name="title" id="title" required style="padding: 10px; border: 1px solid #ddd; border-radius: 5px;">
                </div>
    
                <div class="form-group" style="display: flex; flex-direction: column;">
                    <label for="decision_number" style="font-weight: bold; margin-bottom: 5px;">رقم القرار</label>
                    <input type="text" name="decision_number" id="decision_number" required style="padding: 10px; border: 1px solid #ddd; border-radius: 5px;">
                </div>
                <div class="form-group" style="display: flex; flex-direction: column;">
                    <label for="content" style="font-weight: bold; margin-bottom: 5px;">محتوى القرار</label>
                    <textarea name="content" id="content" required style="padding: 10px; border: 1px solid #ddd; border-radius: 5px;"></textarea>
                </div>
                <div class="form-group" style="display: flex; flex-direction: column;">
                    <label for="decision_date" style="font-weight: bold; margin-bottom: 5px;">تاريخ صدور القرار</label>
                    <input type="date" name="decision_date" id="decision_date" required style="padding: 10px; border: 1px solid #ddd; border-radius: 5px;">
                </div>
